...
| 9 | **Layered and hexagonal architecture (ports & adapters)** | Refactor the notes service so dependencies point *inward*; ports and adapters. Vibe's `APIAdapter` as the live set-piece. |
