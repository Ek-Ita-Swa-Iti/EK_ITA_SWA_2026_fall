...
| 9 | **Layered architecture** | Hands-on: live demo of a minimal two-layer Node.js notes service, then swap its persistence layer yourself — to a JSON API and to MongoDB in Docker. |
