# Session 20: Documentation — ADRs and the C4 Model
...
Then in pairs: write an ADR for a decision you made in sessions 5–6 or 9. Half a page.
...
Live: draw a Context + Container diagram for the project from sessions 13–16.
